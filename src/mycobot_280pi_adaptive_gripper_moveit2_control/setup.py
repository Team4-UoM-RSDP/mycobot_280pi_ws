...
package_name = 'mycobot_280pi_adaptive_gripper_moveit2_control'
...
setup(
    ...
    description='Control package for mycobot 280 PI with adaptive gripper',
    license='BSD',
    tests_require=['pytest'],
    entry_points={
        'console_scripts': [
            'sync_plan_pi = mycobot_280pi_adaptive_gripper_moveit2_control.sync_plan_pi:main',
        ],
    },
)
