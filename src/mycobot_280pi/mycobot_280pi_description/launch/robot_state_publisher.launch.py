...
def process_ros2_controllers_config(context):
    ...
    # Use FindPackageShare to get the correct package path
    pkg_share_moveit = FindPackageShare(package='mycobot_280pi_moveit2_config').find('mycobot_280pi_moveit2_config')

    # Define both source and install paths
    src_config_path = os.path.join(pkg_share_moveit, 'config', robot_name)
    install_config_path = src_config_path  # In ROS2, installed files are accessed from share
...
ARGUMENTS = [
    DeclareLaunchArgument('robot_name', default_value='mycobot_280pi',
...
def generate_launch_description():
    ...
    """
    # Define filenames
    urdf_package = 'mycobot_280pi_description'
    urdf_filename = 'mycobot_280pi.urdf.xacro'
    rviz_config_filename = 'mycobot_280pi_description.rviz'
