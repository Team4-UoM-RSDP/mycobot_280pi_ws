...
def generate_launch_description():
    ...
    package_name_gazebo = 'mycobot_280pi_gazebo'
    package_name_description = 'mycobot_280pi_description'
    package_name_moveit = 'mycobot_280pi_moveit2_config'

    default_robot_name = 'mycobot_280pi'
